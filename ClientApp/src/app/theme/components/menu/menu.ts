...
export const verticalMenuItems = [
  ...
  new Menu(3, 'Exchange Tax List', '/master/exchange-tax-list', null, 'change_circle', null, false, 2),
  ...
  new Menu(7, 'Trade', '/entry/trade-contract', null, 'card_membership', null, false, 5),
  new Menu(8, 'Closing Rate', 'entry/closing-rate', null, 'card_membership', null, false, 5),
  new Menu(9, 'Partywise Closing', '/pagenotfound', null, 'card_membership', null, false, 5),
  new Menu(10, 'Balance Transfer', '/pagenotfound', null, 'card_membership', null, false, 5),
  new Menu(11, 'Trade Closing Transfer', '/pagenotfound', null, 'card_membership', null, false, 5),
  new Menu(12, 'Voucher Trade Delete', '/pagenotfound', null, 'card_membership', null, false, 5),

  new Menu(13, 'Imports', null, null, 'outbox', null, true, 0),
  new Menu(14, 'Trade', '/imports/trade', null, 'outbox', null, false, 13),
  ...
  new Menu(8, 'Trade Register', '/reports/trade-register', null, 'outbox', null, false, 6),
  new Menu(8, 'Standing Report', '/reports/standing-report', null, 'outbox', null, false, 6),
