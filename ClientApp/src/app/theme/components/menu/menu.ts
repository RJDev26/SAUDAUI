...
export const verticalMenuItems = [
  ...
  new Menu(2, 'Master', null, null, 'dashboard', null, true, 0),
  new Menu(3, 'Account', '/master/account', null, 'account_circle', null, false, 2),
  new Menu(3, 'Item', '/master/item', null, 'account_circle', null, false, 2),
  new Menu(3, 'Transporter', '/master/transporter', null, 'local_shipping', null, false, 2),
  new Menu(3, 'Company', '/master/company', null, 'business', null, false, 2),
  new Menu(3, 'Sauda', '/master/sauda', null, 'business', null, false, 2),
  new Menu(3, 'Product', '/master/product', null, 'inventory', null, false, 2),
  new Menu(3, 'Contract Master', '/master/contract-master', null, 'assignment', null, false, 2),
  new Menu(3, 'Brokerage Slab', '/master/brokerage-slab', null, 'group', null, false, 2),
